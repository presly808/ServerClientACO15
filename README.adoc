...
This guide walks you through the process of creating a "ua.artcode.hello world" link:/understanding/REST[RESTful web service] with Spring.
...
`src/main/java/ua.artcode.hello/Greeting.java`
[source,java]
----
include::complete/src/main/java/ua.artcode.hello/Greeting.java[]
----
...
`src/main/java/ua.artcode.hello/GreetingController.java`
[source,java]
----
include::complete/src/main/java/ua.artcode.hello/GreetingController.java[]
----
...
`src/main/java/ua.artcode.hello/Application.java`
[source,java]
----
include::complete/src/main/java/ua.artcode.hello/Application.java[]
----
